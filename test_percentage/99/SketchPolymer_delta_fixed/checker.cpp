...
int main (int argc, char **argv) {
	...
	if (argc < 3) {
		printf ("Usage: checker <csv_line> <output_file> [answer_file = answer_new_threshold_99.out] [n] [m]\n");
		return 0;
	}
	...
	if (argc >= 4) {
		...
		char name_ans[] = "../../../answer_new_threshold_99.out";
		file_ans = fopen (name_ans, "r");
		if (file_ans == NULL) {
			printf ("Cannot open default answer file \"answer_new_threshold_99.out\"!\n");
			return 0;
		}
	}
	if (argc >= 5) {
