...
fig ('Log_Memory', 'F1_Score', 'Memory (Bytes)',
        'F1 Score', 'real_name', df, 'F1_score_PERCENTAGE_50')

# Precision
fig ('Log_Memory', 'Precision', 'Memory (Bytes)',
        'Precision', 'real_name', df, 'Precision_PERCENTAGE_50')

# Recall
fig ('Log_Memory', 'Recall', 'Memory (Bytes)',
        'Recall', 'real_name', df, 'Recall_PERCENTAGE_50')
