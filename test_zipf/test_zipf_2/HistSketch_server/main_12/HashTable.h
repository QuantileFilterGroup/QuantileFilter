...
public:
	...
	size_t get_memory_usage() {
		 ...
		 * 		The designers of HistSketch didn't seem to calculate some constants,
		 * 		So again I helped them :)
		*/
		size_t constants = sizeof (int) + sizeof (uint32_t) + sizeof (uint64_t) * 3;
		return constants +
			slot_num * slot<T, bucket_num>::get_memory_usage();
	}
};
