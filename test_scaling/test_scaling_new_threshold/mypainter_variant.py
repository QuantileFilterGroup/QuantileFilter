...
names = [
    "optimized_sketch_direct_cms_compressed",
    "optimized_sketch_direct_cs_compressed",
...
def fig (x, y, xlabel, ylabel, style, data, name):
    ...
    legend = plt.legend(loc='upper center', bbox_to_anchor=(0.46, 1.4), ncol=2, prop={'weight': 'bold', 'size' : 20})
...
fig ('Log_Memory', 'F1_Score', 'Memory (Bytes)',
        'F1 Score', 'real_name', df, 'F1_score_variant_CAIDA')

# Precision
fig ('Log_Memory', 'Precision', 'Memory (Bytes)',
        'Precision', 'real_name', df, 'Precision_variant_CAIDA')

# Recall
fig ('Log_Memory', 'Recall', 'Memory (Bytes)',
        'Recall', 'real_name', df, 'Recall_variant_CAIDA')