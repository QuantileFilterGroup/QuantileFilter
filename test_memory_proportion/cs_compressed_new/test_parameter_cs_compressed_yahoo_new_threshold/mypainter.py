...
fig ('Log_Memory', 'F1_Score', 'Memory (Bytes)',
        'F1 Score', 'real_name', df, 'F1_score_memory_proportion_yahoo')

# Precision
fig ('Log_Memory', 'Precision', 'Memory (Bytes)',
        'Precision', 'real_name', df, 'Precision_memory_proportion_yahoo')

# Recall
fig ('Log_Memory', 'Recall', 'Memory (Bytes)',
        'Recall', 'real_name', df, 'Recall_memory_proportion_yahoo')